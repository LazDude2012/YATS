/**
 * ITubeConnectable.java provides an API for YATS tiles that connect to one another.
 *
 * Original author: LazDude2012
 *
 * Last revision: 6/25/2013
 *
 * Documentation: Timmietimtim
 *
 * Documentation Updated: Tue 6/25/2013 15:49
 */
package YATS.api;
...
/**
 * ITubeConnectable provides an API for YATS tiles (tubes, extractors, etc.) that connect to each other,
...
public interface ITubeConnectable
{
     ...
     * @param side The side which is to be tested for connection to another connectable tile.
     * @return True if the tile is connected to another connectable tile on the given side, otherwise false.
     */
     ...
     * @param side A ForgeDirection side of the tile to test for connectability.
     * @return True if the side is connectable, false if unconnectable.
     */
